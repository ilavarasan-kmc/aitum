...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.ViewHolder>{
    ...
    public TodoListAdapter(List<String> listdata) {
        this.listdata = listdata;
    }

    public TodoListAdapter(Context applicationContext, ArrayList<String> teamNameList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.itemview_todo_list, parent, false);
