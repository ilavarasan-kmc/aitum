...
public class Kinanthropometry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activty_kinantherometry);
        ...
        toolbar.setTitle("Kinanthrometry Test");
        setSupportActionBar(toolbar);
        // Spinner Drop down elements
        List<String> categories = new ArrayList<String>();
        categories.add("Basic Anthropometry");
        categories.add("Peak Height Velocity");
        categories.add("Skinfold assessment");
        ...
        btn_schedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i_survey = new Intent(Kinanthropometry.this, SurveyActivity.class);
